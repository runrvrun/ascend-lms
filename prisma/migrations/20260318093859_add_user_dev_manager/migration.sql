...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "devManagerId" TEXT,
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_devManagerId_fkey" FOREIGN KEY ("devManagerId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
